% SynCura Review Paper - IEEE DISCOVER style - 7 page target
% Compile on Overleaf: pdfLaTeX + IEEEtran.cls (built-in)
...
\captionsetup[table]{labelfont=bf,textfont=bf,position=top,skip=4pt,font=footnotesize}
\captionsetup[figure]{labelfont=bf,textfont=normal,position=bottom,skip=4pt,font=footnotesize}
...
\author{\IEEEauthorblockN{Fizan Feroz\IEEEauthorrefmark{1}, Abdul Ahad Ikkeri\IEEEauthorrefmark{1}, Fathima Reeha T.A\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Department of Computer Science and Engineering,\\
P.~A.~College of Engineering, Mangalore, India\\
4pa24cs032@pace.edu.in, 4pa24cs002@pace.edu.in, 4pa24cs026@pace.edu.in}
}
...
\centering
\footnotesize
\begin{tabular}{>{\raggedright\arraybackslash}p{0.55cm}>{\raggedright\arraybackslash}p{2.7cm}>{\raggedright\arraybackslash}p{3.8cm}>{\raggedright\arraybackslash}p{4.0cm}>{\raggedright\arraybackslash}p{4.4cm}}
\toprule
No. & Study & What SynCura Adopted & Key Findings & Limitations \\
\midrule
{[1]} & Zheng 2025 TBAL JMIR & Arch-task template; LSTM-96 + attention; rolling risk; past-only 90-min & Dyn.\ 0.936 int.\ 0.919 ext.\ recall 79.1\%; hourly; time attribution & Retro; discharge inflation; ext.\ drop; rich EMR; no bedside \\
{[2]} & Choi 2020 DEWS J-BHI & NEWS2 benchmark; sens/spec/prec/alarms/lead time & Beats NEWS2; $\sim$0.880; per-alert reasons & Retro; correlational; limited workflow \\
{[3]} & Wu 2024 vitals JBD & Core vitals; upper bound 0.926 & Vitals LSTM beats RF/Cox; ext.\ 889 & Cohort mismatch; little explain; no deploy \\
{[4]} & Scheid 2025 wearable NatC & SENSE-INGEST-SCORE-ACT; prototype disclaimer & Cont.\ $\sim$0.89; hours lead & Noise/dropouts; integration gaps \\
{[5]} & Xie 2025 RealMIP npjDM & Missing-data roadmap & Generative 0.957--0.968 eICU/MIMIC/SICdb & Multi-DB; heavy; not local \\
{[6]} & Sadanandan 2026 multi arXiv & Scope control; 0.70--0.85 band; defer notes & Fusion 0.786; survey 31 studies & Privacy/compute/delay; low PPV \\
{[7]} & Wang 2026 explain FrontP & Dual attention+SHAP API/dashboard & 0.79--0.87 + reasons & Single DB; non-causal; thin ops metrics \\
{[8]} & Yan 2026 LSTMvsTr PeerJ & Simple LSTM; unseen-holdout discipline & LSTM 0.802 beats Trans/GRU/RNN/Inf & Modest; stacking cost; no alarm test \\
{[9]} & PhysioNet 2012 & All training; 12f 90-min; patient splits & 4000+4000 stays 48h public & US 2012; sparse; shift \\
\bottomrule
\end{tabular}
\end{table*}
